export default function MobileHeader() {
  return (
    <header className="md:hidden fixed top-0 left-0 right-0 bg-sidebar/95 backdrop-blur border-b border-sidebar-border z-50 h-16 flex items-center px-4 pt-[env(safe-area-inset-top)]">
      ...
      <div className="ml-3 min-w-0 overflow-hidden">
        <span className="font-black text-[15px] text-foreground whitespace-nowrap tracking-tight block truncate">
