...
export default function App() {
  useEffect(() => {
    ...
    if (savedFont && savedFont !== 'Plus Jakarta Sans') {
      ...
      link.href = `https://fonts.googleapis.com/css2?family=${savedFont.replace(/ /g, '+')}:wght@400;500;600;700;800&display=swap`;
      document.documentElement.style.setProperty('--app-font-sans', `"${savedFont}", sans-serif`);
